...
* **Поддержка сохранения историчности данных**: Удалённые продавцы остаются в БД с полем deleted. Продавцы учавствуют в аналитике, если у них были транзакции в заданный период до удаления.
